<?php
// Script to generate dummy teacher evaluations for all teachers in workforce.teachers
...
try {
    ...
    // Fetch all teachers
    $stmt = $pdo->query("SELECT teacher_id FROM workforce.teachers");
    ...
    // Dummy values
    $eval_period_id = 1; // Assuming a valid eval_period_id exists
    ...
    echo "Dummy teacher evaluations generated successfully for all teachers.\n";
